...
We would love for you to contribute to slogx and help make it even better than it is
...
Help us keep slogx open and inclusive. Please read and follow our [Code of Conduct](CODE_OF_CONDUCT.md).

## <a name="question"></a> Got a Question or Problem?
If you have any questions regarding how to use slogx or contributing to this repo
...
In order to reproduce bugs, please fill the *To Reproduce* section when possible.
...
Interestingly, from our experience users often find coding problems themselves while preparing a minimal plunk.
We understand that sometimes it might be hard to extract essentials bits of code from a larger code-base but
we really need to isolate the problem before we can fix it.

Unfortunately, we are not able to investigate / fix bugs without a minimal reproduction, so
we will have to close an issue that doesn't have enough info to be reproduced.

You can file new issues by filling out our [new issue form](https://github.com/loft-orbital/slogx/issues/new/choose) using the **Bug report** template.
...
1. Fork the loft-orbital/slogx repo.
...
1. Commit your changes using a descriptive commit message that follows our
  ...
  is necessary because release notes will be eventually automatically generated from these messages.
...
1. In GitHub, send a pull request to `slogx:main`.
...
* All exposed resources **must be documented**.
